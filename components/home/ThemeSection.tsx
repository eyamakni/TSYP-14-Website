...
export default function ThemeSection() {
  ...
  useEffect(() => {
    ...
    const initTubes = () => {
      if (disposed || !canvasRef.current || !window.__TubesCursor) return;
    ...
    const timer = window.setTimeout(() => {
      ...
      const existingScript = document.getElementById("__tubes-loader");

      if (existingScript) {
        window.addEventListener("__tubes_ready", initTubes, { once: true });
        return;
      }
    ...
    return () => {
      ...
      window.removeEventListener("__tubes_ready", initTubes);
  ...
  return (
    <section id="theme" ref={sectionRef} className={styles.section}>
      <div className={styles.canvasZone}>
        ...
        <div className={styles.titleContent}>
          ...
          >
            ...
            <span className={styles.eyebrowText}>TSYP 14 · Theme</span>
            <span className={styles.eyebrowLine} />
          </motion.div>
          ...
          >
            <span className={styles.titleWhite}>THE </span>
            <span className={styles.titleGradient}>NOOSPHERE</span>
          </motion.h2>
        </div>
      </div>
      ...
      <div className={styles.descriptionZone}>
        ...
        >
          <p className={styles.primaryText}>
            Architects of the Noosphere is a vision where innovation connects
            minds to serve humanity with dignity and transparency.
          </p>
